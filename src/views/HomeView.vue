  ...
  <div class="home">
    ...
    <div class="home-container">
      ...
      <div v-if="isInput" class="user-input">
        <input v-model="starName" type="text" v-on:keypress="submitName" />
      </div>
    ...
    <v-dialog v-if="!isFirstRun" max-width="500">
      ...
      <template v-slot:default="{ isActive }">
        <v-card theme="dark" title="Ir para o menu?">
          ...
          <v-card-actions>
            <div v-on:click="goToMenu" class="dialog-button">Ir para o menu</div>
            <div v-on:click="isActive.value = false" class="dialog-button">Fechar</div>
          </v-card-actions>
        </v-card>
      </template>
    </v-dialog>
